...
import { DEVOPS_MODULES, LEARNING_PATHS, getIcon } from './constants.tsx';
import { Layout, Compass, Layers, Command, Map, ChevronLeft, ChevronRight, Bookmark } from 'lucide-react';

interface SidebarProps {
  activeModuleId: string;
  activePathId: string | null;
  activeView: 'module' | 'cheatsheet' | 'simulator' | 'glossary' | 'learning-path';
